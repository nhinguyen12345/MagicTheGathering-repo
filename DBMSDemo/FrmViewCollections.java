 ...
 * @author nhinguyen
 */
public class FrmViewCollections extends javax.swing.JInternalFrame {
private CollectionHandler CollectionHandler = new CollectionHandler(); 
    ...
    private void populateCollections() throws SQLException{
        String keyword = txtKeyWord.getText();
        CardCollection = CollectionHandler.loadCardCollection(keyword);
        String columns[] = new String[]{"CollectionId", "CardId", "UserId", "Quantity"};
        ...
        tblCollections.setModel(tblModel);
      
         
    }
    public FrmViewCollections() {
        initComponents();
        try {
            populateCollections();
        } catch (SQLException ex) {
            Logger.getLogger(FrmViewCollections.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
     * Creates new form FrmViewCollections
     */
    ...
    private void tblCollectionsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCollectionsMouseClicked
        ...
        if(evt.getClickCount()==2){
            ...
            CardCollection Cardcollection = CardCollection.get(tblCollections.getSelectedRow());
            FrmUpdateCollections frmUpdateCollections = new FrmUpdateCollections(null, true);
            frmUpdateCollections.setCard(Cardcollection);
            frmUpdateCollections.setVisible(true);
            if (frmUpdateCollections.getReturnStatus() == FrmUpdateCollections.RET_OK){
                refreshTable();
            }
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int selectedRow = tblCollections.getSelectedRow();
        if(selectedRow!=-1){
            int CollectionId = (int) tblCollections.getValueAt(selectedRow, 0);//1st column
            int ret = JOptionPane.showConfirmDialog(this, String.format("Deleting card ID %d", CollectionId));
            if (ret == JOptionPane.OK_OPTION){
                CollectionHandler.deleteCard(CollectionId);
                refreshTable();
            }
